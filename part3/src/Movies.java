...
public class Movies {
    ...
    public static List<Movie> movies() {
        // We can mix Java and Scala code! "Movie" here is in Scala (a case class) rather than being a Java class,
        // but they can interoperate since Scala and Java both run on the JVM.
        return List.of(
